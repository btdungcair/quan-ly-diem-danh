...
my_game['columns'] = ('player_id', 'player_name', 'player_Rank', 'player_states', 'player_city', 'afdssdfsdsd', 'fsdfsfsd')
...
my_game.column("afdssdfsdsd",anchor=CENTER,width=80)
my_game.column("fsdfsfsd",anchor=CENTER,width=80)
...
my_game.heading("afdssdfsdsd",text="States",anchor=CENTER)
my_game.heading("fsdfsfsd",text="States",anchor=CENTER)
